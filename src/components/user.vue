...
<template>
    <div class="card bg-base-100  w-full h-[120px] min-h-[120px] max-h-[120px] overflow-hidden border border-base-300 cursor-pointer"
        ...
        <div class="card-body p-2 flex flex-col">
            <div class="flex flex-row w-full h-3/4">
                ...
                <div class="cont_dati w-full h-full flex flex-col col-span-4">
                    ...
                    <p class="text-secondary">{{props.dati_op.plant}}</p>
            ...
            <div class="cont_badges felx flex-col w-full col-span-5 h-[25px]">
                ...
                <div class="badge badge-soft badge-error me-1" v-if="props.dati_op.turno=='Manca'">{{props.dati_op.turno}} Turno</div>
