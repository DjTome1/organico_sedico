        ...
        <div class="tab-content bg-base-100 border-base-300 p-6 ">
            ...
            <div class="collapse collapse-plus bg-base-100 border border-base-300 mb-1" >
                ...
                <div class="collapse-content text-sm">
                    ...
                    <div class="overflow-x-auto grid grid-cols-4 gap-2 p-1">
            ...
            <div class="collapse collapse-plus bg-base-100 border border-base-300 mb-1">
                ...
                <div class="collapse-content text-sm">
                    <div class="overflow-x-auto grid grid-cols-3 gap-2 p-1" v-if="is_strutt_data_loaded">
                        <label class="select my-1 w-full" id="prest"> 
                    ...
                    <div class="overflow-x-auto flex flex-col justify-center items-center p-1" v-if="!is_strutt_data_loaded">
                                ...
                                <tr>
                                    <td v-for="i in 10">
                                        <select class="select select-sm" :id="`sk${i}_${index}`" v-model="html_skill_matrix[index][i - 1]">
                                            <option disabled selected value="">Seleziona Una Skill</option>
